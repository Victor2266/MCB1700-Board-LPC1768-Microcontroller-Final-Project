...
- Custom High Performance Graphical Library (with Transparent Text, Line, Circle, and Box Renderers (both outlined and filled), screen wipe transitions)
- Under 512kb size limit
