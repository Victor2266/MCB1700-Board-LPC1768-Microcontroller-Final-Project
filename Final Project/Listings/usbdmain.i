...
uint32_t *InfoBuf = (uint32_t *)((0x20080000 + (128 + (16 * 16) + (8 * 20))));
short *DataBuf = (short *)((0x20080000 + (128 + (16 * 16) + (8 * 20))) + 4*4);
...
void get_potval (void) {
  ...
  ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->CR |= 0x01000000;               
  do {
    val = ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->GDR;                    
...
void TIMER0_IRQHandler(void) 
{
  ...
  ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->CR = val & 0xFFC0;              
...
int USBAudio_Init (void)
{
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &=~((0x03<<18)|(0x03<<20));  
   
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 |= ((0x01<<18)|(0x02<<20));

   
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1 << 12);

  ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->CR = 0x00200E04;		 
  ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->CR = 0x00008000;		 

  
 
   
  pclkdiv = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0 >> 2) & 0x03;
  switch ( pclkdiv )
  {
	case 0x00:
	default:
  ...
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR0 = pclk/32000 - 1;	 
