...
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~((3<< 8)|(3<<14)|(3<<16)|(3<<18)|(3<<20));
 
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~((1<<20)|(1<<23)|(1<<24)|(1<<25)|(1<<26));
}
...
uint32_t kbd_val;
kbd_val = (((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN >> 20) & 0x79;
return (kbd_val);
}
