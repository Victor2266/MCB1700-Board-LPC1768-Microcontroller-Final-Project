...
#line 11 "GameScript.c"

#line 20 "GameScript.c"
...
void Game_Script_Init(void) {
    ...
    GLCD_Clear(0x0000);
    GLCD_DrawCircle(320/2, 240/2, 10, 0x001F);  
    GLCD_DisplayStringCutout(0, 0, 1, "Score: 0", 0xFFFF);
    
    
    for ( i = 0; i < player.health; i++) {
        GLCD_DrawLine(305 - i*20, 5, 305 - i*20, 15, 0xF800);
        GLCD_DrawLine(310 - i*20, 10, 300 - i*20, 20, 0xF800);
    }
}
...
void SpawnEnemy(void) {
    ...
    for ( i = 0; i < 50; i++) {
        if (!enemies[i].active) {
            ...
            switch (side) {
                case 0:  
                    enemies[i].x = player.x + (rand() % 320) - 320/2;
                    enemies[i].y = player.y - 240/2 - 20;
                    break;
                case 1:  
                    enemies[i].x = player.x + (rand() % 320) - 320/2;
                    enemies[i].y = player.y + 240/2 + 20;
                    break;
                case 2:  
                    enemies[i].x = player.x - 320/2 - 20;
                    enemies[i].y = player.y + (rand() % 240) - 240/2;
                    break;
                case 3:  
                    enemies[i].x = player.x + 320/2 + 20;
                    enemies[i].y = player.y + (rand() % 240) - 240/2;
...
void Game_Script_Input(uint32_t key) {
    switch(key) {
        case 0x08:
            ...
            break;
        case 0x20:
            if (player.y < 720) player.y += player.speed;
            break;
        case 0x40:
            if (player.x > 0) player.x -= player.speed;
            break;
        case 0x10:
            if (player.x < 960) player.x += player.speed;
            break;
    }
}
