...
void MainMenu_Init(void) {
  ...
  GLCD_Bitmap( 43, 80, 64, 64, GALLERY_ICON_pixel_data);
  GLCD_Bitmap(128, 80, 64, 64, MUSIC_ICON_pixel_data);
  GLCD_Bitmap(213, 80, 64, 64, GAME_ICON_pixel_data);
}
...
void MainMenu_Update(uint32_t ticks) {
  ...
  if(needs_update) {
    ...
    for(i = 0; i < 3; i++) {
      if(i == menu_select) {
        GLCD_DrawBox((43-4)+i*85, 80-4, 72, 72, 0xFFFF);
      }
    }
