...
#include <stdint.h>
// extern means that the variable is defined elsewhere, we just
// want to refer to it here. This is the actual value of the
// joystick buttons, updated by the interrupt routine.
