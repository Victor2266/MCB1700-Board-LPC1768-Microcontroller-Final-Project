...
#define PATTERN_LEFT_TO_RIGHT 0
#define PATTERN_RIGHT_TO_LEFT 1
#define PATTERN_TOP_TO_BOTTOM 2
#define PATTERN_BOTTOM_TO_TOP 3
#define PATTERN_CENTER_OUT    4
#define PATTERN_OUTSIDE_IN    5
